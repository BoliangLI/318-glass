...
import { Copy, Check, Sparkles, Download, Eye } from "lucide-react";
        ...
        <nav className="glass sticky top-0 z-50 mx-4 mt-4 rounded-2xl">
          <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold text-foreground">毛玻璃设计器</span>
            </div>
            
            <div className="flex items-center gap-3">
              <Button
                variant="outline"
                className="glass text-foreground border-foreground/30 hover:bg-white/20 rounded-full"
                onClick={() => navigate("/")}
              >
                返回首页
              </Button>
